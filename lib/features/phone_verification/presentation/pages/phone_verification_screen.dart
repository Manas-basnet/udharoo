...
class _PhoneVerificationScreenState extends State<PhoneVerificationScreen> {
  ...
  void _verifyCode(PhoneVerificationCubit cubit) {
  ...
  bool get _isChanging => context.read<PhoneVerificationCubit>().isChangingPhoneNumber;
                  ...
                  children: [
                    ...
                    BlocBuilder<PhoneVerificationCubit, PhoneVerificationState>(
                      builder: (context, state) {
                        ...
                        return TextButton(
                          onPressed: () => _handleBackButton(cubit),
                          child: Text(
                            _getBackButtonText(),
                            style: TextStyle(
                              color: theme.colorScheme.onSurface.withOpacity(0.6),
